...
def generate_weekly_briefing() -> str:
    ...
    system = (
        ...
        "마크다운 볼드(**)·번호목록 쓰지 말 것. 아래 섹션 형식(머리말 '### '):\n\n"
        "### Executive Takeaway\n- 이번 주 판을 바꾸는 핵심 변화 3~4개. 각 줄에 근거 브랜드·시장.\n\n"
        "### 권역별 핵심 움직임\n- 데이터에 나온 권역(EU·ME·SEA·IN·NA 등)별로 가장 중요한 경쟁 움직임을 "
        "'- [권역] 브랜드: 무엇을 어디서(채널) → 왜 중요' 형식으로. 활동 있는 권역만.\n\n"
        "### 주요 무브먼트 상세 (Top 5~7)\n- strategic score 높은 순. 각 줄: 브랜드 / 국가 / 활동 / 채널 / 근거 / score / "
        "2문장 분석(무엇을·왜 중요·우리 접점). 75점↑ '[즉시공유]'.\n\n"

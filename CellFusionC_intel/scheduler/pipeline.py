    ...
    for raw, clf in classified:
        try:
            article = NewsArticle(
                ...
                channel=getattr(clf, "channel", None),
                price_info=getattr(clf, "price_info", None),
                city=getattr(clf, "city", None),
                evidence_level=getattr(clf, "evidence_level", None),
                strategic_score=getattr(clf, "strategic_score", None),

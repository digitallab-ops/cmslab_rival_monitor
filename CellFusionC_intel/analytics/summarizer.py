...
_TONE_GUIDE = (
    "【톤앤매너 — 반드시 지킬 것】 지시·명령형('~해야 한다', '~강화하라', '~방어하라', "
    "'~인지해야 한다')이 아니라 **조언형**으로 쓴다: '~해볼 만하다', '~을 점검할 필요가 "
    "있어 보인다', '~는 참고할 만하다', '~를 고려해볼 수 있다'. 근거가 확실하면 자신 있게 "
    "권하되, 근거가 약하면 '이런 흐름도 있으니 한 번 봐두면 좋겠다' 정도로 수위를 낮춘다. "
    "단정·과장·강요는 피하고, 사실은 사실대로 짚되 제안은 부드럽게."
)
...
그 위에서 우리(선케어·더마) 관점의 총평을 얹어라. "이 브랜드는 ~~ 전략으로 ~~ 방향으로 크고 있어, 우리는 ~~ 관점에서
대응/활용하면 좋다"는 흐름. 구체적이되 개별 액션의 재나열은 금지 — 관통하는 방향성과 총평.
